...
public class BioLincc_Record
{
    ...
    public string? datasets_updated { get; set; }
    public DateTime? datasets_updated_date { get; set; }
...
public class RelatedStudy
{
    ...
    public RelatedStudy(string? _study_link, string? _link_text)
    {
        study_link = _study_link;
