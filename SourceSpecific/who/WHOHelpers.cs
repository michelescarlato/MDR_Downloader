...
namespace MDR_Downloader.who
{
    public class WHOHelpers
    {
        ...
        public List<StudyFeature> AddIntStudyFeatures(List<StudyFeature> study_features, string design_list)
        {
            string design = design_list.Replace(" :", ":").ToLower(); // to make comparisons easier

            if (design.Contains("purpose: treatment"))
            {
                study_features.Add(new StudyFeature(21, "Primary purpose", 400, "Treatment"));
            }
            if (design.Contains("purpose: diagnosis")
                || design.Contains("diagnostic"))
            {
                study_features.Add(new StudyFeature(21, "Primary purpose", 410, "Diagnostic"));
            }    
            if (design.Contains("supportive care")
                || design.Contains("purpose: supportive"))
            {
                study_features.Add(new StudyFeature(21, "Primary purpose", 415, "Supportive care"));
            }
        ...
        public List<StudyFeature> AddObsStudyFeatures(List<StudyFeature> study_features, string design_list)
        {
            ...
            if (des_list.Contains("observational study model"))
            {
                ...
                {
                    study_features.Add(new StudyFeature(30, "Observational model", 600, "Cohort"));
                }
                if (des_list.Contains("case-control") || des_list.Contains("case control"))
                {
                    study_features.Add(new StudyFeature(30, "Observational model", 605, "Case-control"));
                }
                if (des_list.Contains("case-crossover") || des_list.Contains("case crossover"))
                {
                    study_features.Add(new StudyFeature(30, "Observational model", 615, "Case-crossover"));
                }
            ...
            if (des_list.Contains("time perspective"))
            {
                ...
                {
                    study_features.Add(new StudyFeature(31, "Time perspective", 700, "Retrospective"));
                }
                if (des_list.Contains("prospective"))
                {
                    study_features.Add(new StudyFeature(31, "Time perspective", 705, "Prospective"));
                }
                if (des_list.Contains("cross-sectional") || des_list.Contains("crosssectional"))
                {
                    study_features.Add(new StudyFeature(31, "Time perspective", 710, "Cross-sectional"));
                }
                if (des_list.Contains("longitudinal"))
                {
                    study_features.Add(new StudyFeature(31, "Time perspective", 730, "longitudinal"));
                }
            }
            ...
            if (des_list.Contains("biospecimen retention"))
            {
                ...
                {
                    study_features.Add(new StudyFeature(32, "Biospecimens retained", 800, "None retained"));
                }
                if (des_list.Contains("collect & archive- sample with dns"))
                {
                    study_features.Add(new StudyFeature(32, "Biospecimens retained", 805, "Samples with DNA"));
                }
            }
            return study_features;
        }
        ...
        public List<StudyFeature> AddMaskingFeatures(List<StudyFeature> study_features, string design_list)
        {
            string design = design_list.Replace(" :", ":").ToLower(); // to make comparisons easier
        ...
        public List<StudyFeature> AddPhaseFeatures(List<StudyFeature> study_features, string phase_list)
        {
